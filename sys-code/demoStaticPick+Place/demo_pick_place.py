...
# Helper function to place a cube on the target
def place_cube(cube_pose, target_pose, cube_pose_z_offset=0.1, stack_position=0, cube_size=0.05, stack_offset=0.001):
    #Move above cube
    ...
    # Move up again
    rtde_c.moveL(pose=[target_pose[0], target_pose[1], target_pose[2]+cube_pose_z_offset+stack_position*0.05, target_pose[3], target_pose[4], target_pose[5]], speed=SPEED_FAST, acceleration=0.3)


place_cube(green_cube_pose, target_pose, cube_pose_z_offset=0.1, stack_position=0)
place_cube(orange_cube_pose, target_pose, cube_pose_z_offset=0.1, stack_position=1)
place_cube(red_cube_pose, target_pose, cube_pose_z_offset=0.1, stack_position=2)